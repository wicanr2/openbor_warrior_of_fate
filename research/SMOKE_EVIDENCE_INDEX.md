...
| --- | --- | --- | --- |
| ν Gundam | [NU_GUNDAM_RUNNER_QA.md](NU_GUNDAM_RUNNER_QA.md) | Runner checklist consolidates the still-open visible QA and confirms the runtime validator / smoke context. | Visible runner QA, Stage 1 gameplay, Windows/macOS runner smoke, production in-betweens, Funnel P1 |
...
| ν Gundam runtime audit | [NU_GUNDAM_RUNTIME_AUDIT.md](NU_GUNDAM_RUNTIME_AUDIT.md) | Separates P0 engineering runtime, visible runner gaps, and production remaining into one concise audit. | Visible runner QA, Stage 1 gameplay, Windows/macOS runner smoke, production in-betweens, Funnel P1 |
...
| Getter runner QA | [GUANYU_RUNNER_QA.md](GUANYU_RUNNER_QA.md) | Visible runner checklist for Getter; adds the `guanyu_select_stage1` macro to the reusable harness. | Visible gameplay / screenshot verification, Stage 1 gameplay loop, Windows/macOS runner smoke, production animation closure |
