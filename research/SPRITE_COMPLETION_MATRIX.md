...
| Lidian 紅槍指揮機 | `assets/bosses/lidian-red-spear-commander/candidates/lidian-p1-interpolated-v1` | 79 GIF | 79 張獨立插值 raster；strict parity、canvas、palette index 0 PASS；private `lidian-v1` production redraw seed 9/16 idle/walk/thrust/sweep/jump/charge/strike/special/pain | 7 個 keypose、槍擊 charge／impact FX、裝甲碎片逐件拆分、in-between、BBox／attack-box、Boss hit/death review | interpolated candidate＋production seed |
