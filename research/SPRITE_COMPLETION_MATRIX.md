...
| 量產敵 family／army 1–10 | `assets/enemies/army-family-p1-interpolated-v1` | 522 GIF | 十個 model 共 522 張獨立插值 raster；522/522 strict parity、canvas、palette index 0 PASS；522/522 BBox manifest entries verified；十型皆已有各四格 150×120 runtime seed：島田兵、重裝近戰、射擊、空中偵察、盾衛、履帶砲擊、高速近戰、四足突擊、干擾支援與小隊指揮機 `squad-commander-v1`；十個 seed package／40 張 GIF 已重新跑 canvas、indexed palette、index-0 `#FC00FF` 與無 transparency-extension gate；島田兵修正了遺留透明 extension，第十型拒絕含脫離零件的初稿後重切 | 每個 model 的獨立造型逐格 production redraw、shooter／muzzle、死亡碎片、model-specific attack-box／gameplay review | interpolated candidate＋BBox handoff＋runtime seed |
