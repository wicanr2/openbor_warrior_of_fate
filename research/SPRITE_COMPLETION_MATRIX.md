...
| 張飛／無敵鐵金剛／兜甲兒 | `assets/players/zhangfei` | 44 GIF | P0 41 physical GIF coverage；`mazinger-production-p1-interpolated-v1` 已產出 41 張獨立插值 raster 並通過 parity；private `mazinger-v1` production redraw seed 12/16 keyposes | 4 個 keypose、手繪清線／in-between、特殊技、抓投、倒地碎片、BBox review 與 2P palette | interpolated candidate＋production seed |
