...
| 量產敵 family／army 1–10 | `assets/enemies/army-family-p1-interpolated-v1` | 522 GIF | 十個 model 共 522 張獨立插值 raster；522/522 strict parity、canvas、palette index 0 PASS；522/522 BBox manifest entries verified；另有第一型島田兵 `shimada-grunt-v1` 與第二型重裝近戰機 `heavy-bruiser-v1`，各四格 150×120 runtime seed | 每個 model 的獨立造型逐格 production redraw、shooter／muzzle、死亡碎片、model-specific attack-box／gameplay review | interpolated candidate＋BBox handoff＋runtime seed |
