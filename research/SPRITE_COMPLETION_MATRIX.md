...
| Boss family（Lidian／Meiling／Meimei／Meiya／夏侯惇／Xuchu） | `assets/bosses/boss-family-p1-interpolated-v1`、`BOSS-FAMILY-MEDIUM-MANIFEST.json` | 405 GIF | 六個 model 共 405 張 private p0 GIF；405/405 通過 Boss medium validator，canvas 全部 ≤640×360（最大 480×272）、indexed palette、index-0 `#FC00FF`、無 transparency extension | 每個 Boss 獨立造型逐格 production redraw、HUD／icon、projectile／debris、pilot cut-in、model-specific attack-box／gameplay review | medium Boss engineering coverage＋manifest |
...
| Jade Strategist 原創女 Boss | `assets/bosses/jade-strategist/candidates/jade-strategist-medium-v1` | 16 GIF | 原創翡翠綠／石墨 4×4 storyboard 切出 16 張 `180×144` medium Boss GIF；16/16 通過 indexed palette、index-0 `#FC00FF`、無 GIF transparency extension；source storyboard 與 `MEDIUM-MANIFEST.json` 僅在 private repo | 依 Stage03B Boss slot 對應 model TXT、HUD portrait、attack-box／pivot、FX 與 gameplay review | original medium candidate |
...
| 五人／六人選角 | `assets/ui/five-player-selection/overlay`、`assets/ui/six-player-selection/overlay`、`SELECTION-MEDIUM-MANIFEST.json` | 2 GIF | 五人與六人選角 overlay 各 1 張 `480×276`；2/2 strict medium 驗證通過，六人 slot manifest 定義六個 80×276 slot | 游標、READY、confirm、portrait／HUD 分離 sprite 的 production review | medium UI coverage＋slot handoff |
