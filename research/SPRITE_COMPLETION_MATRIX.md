...
| 量產敵 family／army 1–10 | `assets/enemies/army-family-p1-interpolated-v1` | 522 GIF | 十個 model 共 522 張獨立插值 raster；522/522 strict parity、canvas、palette index 0 PASS；522/522 BBox manifest entries verified；另有島田兵、重裝近戰機、射擊兵、空中偵察機、盾衛機、履帶砲擊機、高速近戰機、四足突擊機與第九型干擾支援機 `jammer-support-drone-v1`，各四格 150×120 runtime seed；四足機完整四足與干擾支援機完整工具臂／脈衝安全切圖皆已檢查 | 每個 model 的獨立造型逐格 production redraw、shooter／muzzle、死亡碎片、model-specific attack-box／gameplay review | interpolated candidate＋BBox handoff＋runtime seed |
