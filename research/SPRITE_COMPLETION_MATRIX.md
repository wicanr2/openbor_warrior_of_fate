...
| ν Gundam／第六角色／阿姆羅系 | `assets/players/nu-gundam` | 78 GIF＋2 TXT | `nu-p1-interpolated-v1` 73 張獨立插值 raster；private `funnel-v1` exact-canvas proxy candidates＋3 independent effect redraw seeds＋three 3-frame timing candidates；private `nu-v1` 16/16 cleaned keyposes＋16 張 202×120 runtime GIF＋BBox manifest | Funnel orbit／beam／return 的獨立逐格 redraw、timing／cleanup、手繪清線、P1 special、gameplay BBox review | interpolated candidate＋runtime keypose seed＋effect proxy/redraw seed |
