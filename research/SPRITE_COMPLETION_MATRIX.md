...
| 黃忠／RX-78／阿姆羅 | `assets/players/huangzhong` | 97 GIF | `rx78-p1-interpolated-v1` 73 張獨立插值 raster；derived source；private `rx78-v1` production redraw seed 8/16 keyposes | 8 個 keypose、projectile flight／impact／muzzle、手繪清線、special／抓投／in-between | derived interpolated candidate＋production seed |
