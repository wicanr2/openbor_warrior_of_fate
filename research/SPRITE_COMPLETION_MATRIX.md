...
| 趙雲／EVA／碇真嗣 | `assets/players/zhaoyun` | 84 GIF | `eva-p1-interpolated-v1` 82 張獨立插值 raster；derived source；private `eva-v1` production redraw seed 8/16 keyposes | 8 個 keypose、P1／P2 特效與抓投、手繪清線、武器／受擊逐格 review | derived interpolated candidate＋production seed |
