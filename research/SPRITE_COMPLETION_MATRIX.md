...
| 原創化黑白大型 Boss | `assets/bosses/super-robot-boss-v1` | 8 GIF | private fan-use／rights-unverified `super-robot-v1` 四張 220×160 runtime seed；idle、heavy punch、chest cannon、wreckage；另有 4-frame chest-cannon charge／beam／impact／fade FX；BBox manifest，public repo 不保存個別圖檔 | 12 姿勢、HUD／icon、projectile／debris、pilot cut-in、手繪、attack-box／gameplay QA | private runtime／FX seed＋BBox handoff |
