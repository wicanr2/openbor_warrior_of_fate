...
| ν Gundam／第六角色／阿姆羅系 | `assets/players/nu-gundam` | 78 GIF＋2 TXT | `nu-p1-interpolated-v1` 73 張獨立插值 raster；Funnel proxy 保留；private `nu-v1` production redraw seed 5/16 keyposes | 11 個 keypose、Funnel orbit／beam／return／cleanup、手繪清線、P1 special、BBox review | interpolated candidate＋production seed |
