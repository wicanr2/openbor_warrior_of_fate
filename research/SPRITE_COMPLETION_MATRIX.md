...
| 魏延／機械哥吉拉／迷你哥吉拉 | `assets/players/weiyan` | 91 GIF＋3 TXT | `riftbeast-p1-interpolated-v1` 84 張獨立插值 raster；tail-ray proxy 保留；private `riftbeast-v1` production redraw seed 10/16 portrait/spawn/idle/walk/claw-windup/tail-sweep/tail-cannon/double-claw-spin/jump/pain | 6 個 keypose、尾砲 charge／beam／impact、爪／dash FX、in-between、BBox review | interpolated candidate＋production seed |
