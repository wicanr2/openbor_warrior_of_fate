...
| 趙雲／EVA／碇真嗣 | `assets/players/zhaoyun` | 84 GIF | `eva-p1-interpolated-v1` 82 張獨立插值 raster；derived source；private `eva-v1` production redraw seed 16/16 keyposes＋1 in-between seed | P1／P2 特效與抓投、其餘手繪清線／in-between、武器／受擊逐格 review | derived interpolated candidate＋complete keypose seed＋in-between seed |
