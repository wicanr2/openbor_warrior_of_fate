...
| 島田兵／藍盔一般敵 | `assets/enemies/blue-helmet-grunt/candidates/blue-helmet-p1-interpolated-v1` | 42 GIF | 42 張獨立插值 raster；42/42 strict parity、canvas、palette index 0 PASS；private `blue-helmet-v1` 12/12 keypose＋10 in-between＋3 projectile＋3 death-fragment seed | `bingxs` a4 lifecycle decision、其餘 in-between、offset/BBox／attack-box 與逐格 production review | interpolated candidate＋keypose/effect/in-between seeds |
