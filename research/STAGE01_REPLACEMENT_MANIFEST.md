...
| --- | ---: | --- | --- | --- | --- | --- |
| `bing` | 30 / 27 / 0 | `data/chars/army/1/bing.txt` | 31；81×91～154×106 | 基礎近戰兵 | P0 | M1 唯一完整雜兵：黃巾配色的量產近戰機／無人甲兵，長槍或電棍；先做一個 palette，其他 Map 後補 |
...
| `lidian` | 1 / 0 / 0 | `data/chars/boss/lidian/lidian.txt`＋`li.txt` | 51；110×102～269×139 | `01.txt` Boss | P1 | 古將輪廓的指揮官機；保留 269×139 大畫布和長武器動勢。另有 480×272 Boss icon，需同步重畫 |
