...
| `fglayer` ×2 | `data/bgs/01/f.gif` | `data/bgs/01/f.GIF` | 2429×272 | 近景遮擋層；以 x=-220、-20 重複掛載 | P0 | 竹林、樹幹與草叢保留，混入斷裂機械臂、管線、補給布幔；透明區與遮擋輪廓必須逐段驗證 |
...
| --- | ---: | --- | --- | --- | --- | --- |
| `bing` | 30 / 27 / 0 | `data/chars/army/1/bing.txt` | 31；81×91～154×106 | 基礎近戰兵 | P0 | M1 唯一完整雜兵：藍灰量產巡邏機／無人甲兵，長槍或電棍；24×36 icon 採原創藍盔島田兵式語彙，先做一個 palette，其他 Map 後補 |
...
| `lidian` | 1 / 0 / 0 | `data/chars/boss/lidian/lidian.txt`＋`li.txt` | 51；110×102～269×139 | `01.txt` Boss | P1 | 藍黑裝甲、橙色軍階與長柄高周波兵器的量產軍指揮官機；保留 269×139 大畫布和長武器動勢。另有 480×272 Boss icon，需同步重畫 |
