  ...
  assertExistingPaths([
    {
      ...
      pathLabel: 'Huangzhong source directory',
    ...
    {
      path: options.projectileDir,
      pathLabel: 'Huangzhong projectile directory',
      display: repoRelativeDisplay(REPO_ROOT, options.projectileDir),
      hint: 'This repository does not ship the private source assets; pass --projectile-dir to an external checkout.',
    },
    {
