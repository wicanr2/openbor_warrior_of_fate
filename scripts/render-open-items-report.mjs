...
lines.push('');
lines.push('- [Stage01 Linux smoke evidence](STAGE01_LINUX_SMOKE.md)');
lines.push('- [Lidian Linux smoke evidence](LIDIAN_LINUX_SMOKE.md)');
lines.push('- [Huangzhong Linux smoke evidence](HUANGZHONG_LINUX_SMOKE.md)');
